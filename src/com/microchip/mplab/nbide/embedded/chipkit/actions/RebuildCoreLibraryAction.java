        ...
        public void actionPerformed(ActionEvent e) {            
            RP.post( () -> {
                ...
                try {                    
                    ...
                    Path coreDirPath = Paths.get( project.getProjectDirectory().getFileObject( ChipKitProjectImporter.CORE_DIRECTORY_NAME ).getPath() );            
                    Path makefilePath = coreDirPath.resolve( LibCoreBuilder.MAKEFILE_FILENAME );                    
                    libCoreBuilder.buildLibCore( makefilePath, toolFinder, (m) -> {
                        io.getOut().println(m);
                    } );
